  ...
  return (
    <div className='fixed w-full h-[70px] flex justify-between items-center px-4 bg-[#0a192f] text-gray-300'>
      ...
      <ul className="hidden md:flex">
        ...
        <NavLink exact="true" activeclassname="active" to="/about" onClick={() => setNav(false)} className="navLink">About</NavLink>
        <NavLink exact="true" activeclassname="active" to="/work" onClick={() => setNav(false)} className="navLink">Work</NavLink>
